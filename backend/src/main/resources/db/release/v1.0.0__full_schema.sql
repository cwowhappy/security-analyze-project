...
-- 证券分析系统第一个正式版本的完整数据库结构
-- 适用场景：全新环境一键初始化（无需执行 V1~V6 增量脚本）
-- PostgreSQL 16+
-- ============================================================
